...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Use the current year to position the event correctly
        $currentYear = date("Y");
        $dobThisYear = date("$currentYear-m-d", strtotime($dob));

        // Add event data for FullCalendar
        $events[] = array(
            'title' => $name, // Show only the name on calendar
                    ...
                    <!-- <div class="px-6 pb-2">
                        ...
                        <div class="app-calendar-events-filter text-heading">
                            <div class="form-check form-check-danger mb-5 ms-2">
                                <input class="form-check-input input-filter" type="checkbox" id="select-birthday" data-value="birthday" checked />
                                <label class="form-check-label" for="select-birthday">Birthday</label>
                            </div>
                            <div class="form-check form-check-warning mb-5 ms-2">
                                <input class="form-check-input input-filter" type="checkbox" id="select-anniversary" data-value="anniversary" checked />
                                <label class="form-check-label" for="select-anniversary">Anniversary</label>
                            </div>
                            <div class="form-check form-check-info mb-5 ms-2">
                                <input class="form-check-input input-filter" type="checkbox" id="select-children-birthday" data-value="children-birthday" checked />
                                <label class="form-check-label" for="select-children-birthday">Children's Birthday</label>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg rounded">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title font-weight-bold"><i class="fas fa-birthday-cake"></i> Birthday Details</h5>
            ...
            <div class="modal-body p-4">
                <div class="text-center">
                    <h4 id="eventName" class="font-weight-bold text-primary"></h4>
                    <p id="eventDate" class="text-muted mb-2"><i class="fas fa-calendar-alt"></i> <span></span></p>
                    <p id="eventPhone" class="mb-3"><i class="fas fa-phone"></i> <span></span></p>
                </div>
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary close-modal px-4" data-dismiss="modal">
...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
        ...
        eventRender: function(event, element) {
            // Ensure only name shows in the calendar
            element.find('.fc-title').text(event.title);
        },

        eventClick: function(event) {
            // Show Bootstrap modal with birthday details
            $('#eventModal .modal-title').text("🎂 Birthday Details");
            $('#eventModal .modal-body').html(event.description);
