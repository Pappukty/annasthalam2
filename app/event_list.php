...
if (isset($_POST['delete_now'])) {
    ...
    $query = "DELETE FROM event WHERE index_id = ?";
...
<div class="row">
    ...
    <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <?php $select = "SELECT * FROM `event` WHERE index_id!='0' ORDER BY index_id DESC";
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($Row->photos != '') { ?>
                                <a href="./uploads/events/<?php echo $Row->photos; ?>" target="_blank"><img src="./uploads/events/<?php echo $Row->photos; ?>" class=" header-profile-user" width="60" alt="" data-demo-src="./uploads/events/<?php echo $Row->photos; ?>"></a>
                            <?php } ?>
                        </td>
