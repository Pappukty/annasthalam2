...
if (isset($_POST['delete_now'])) {
    ...
    $query = "DELETE FROM counter WHERE index_id = ?";
...
<div class="row">
        <div class="col-6"><h3 class="mb-3 text-start">Counter List</h3></div>
        <div class="col-6">
    ...
    <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <?php $select = "SELECT * FROM `counter` WHERE index_id!='0' ORDER BY index_id DESC";
            ...
            ?>
                    <tr>
                        ...
                        <td>
                      <a class=" edit-board p-2 alert-box-trigger waves-effect waves-light kill-drop" href="counter_add.php?id=<?php echo $Row->index_id; ?>"><button class="btn btn-warning btn-sm">Edit</button></a>
...
<div id="delete-board-alert" class="modal fade alert-box" tabindex="-1" role="dialog" aria-hidden="true">
    <form action="event_list.php" method="post" name="delete_form" id="delete_form">
