    ...
    <div class='d-flex flex-wrap align-items-center'>
      ...
      ${e.text}
        ...
        function I() {
            ...
            e.setAttribute("data-bs-toggle", "sidebar"), e.setAttribute("data-overlay", ""), e.setAttribute("data-target", "#app-calendar-sidebar"), e.insertAdjacentHTML("beforeend", '<i class="icon-base bx bx-menu icon-lg text-heading"></i>')
        }
        ...
        let S = new Calendar(w, {
            ...
            dateClick: function(e) {
                ...
                F(), L.show(), a && (a.innerHTML = "Add Event"), l.innerHTML = "Add", l.classList.remove("btn-update-event"), l.classList.add("btn-add-event"), i.classList.add("d-none"), o.value = e, s.value = e
            },
            eventClick: function(e) {
                e = e, (E = e.event).url && (e.jsEvent.preventDefault(), window.open(E.url, "_blank")), L.show(), a && (a.innerHTML = "Update Event"), l.innerHTML = "Update", l.classList.add("btn-update-event"), l.classList.remove("btn-add-event"), i.classList.remove("d-none"), d.value = E.title, D.setDate(E.start, !0, "Y-m-d"), !0 === E.allDay ? m.checked = !0 : m.checked = !1, null !== E.end ? P.setDate(E.end, !0, "Y-m-d") : P.setDate(E.start, !0, "Y-m-d"), f.val(E.extendedProps.calendar).trigger("change"), void 0 !== E.extendedProps.location && (u.value = E.extendedProps.location), void 0 !== E.extendedProps.guests && h.val(E.extendedProps.guests).trigger("change"), void 0 !== E.extendedProps.description && (v.value = E.extendedProps.description)
            },
            datesSet: function() {
                I()
            },
        ...
        function F() {
            s.value = "", c.value = "", o.value = "", d.value = "", u.value = "", m.checked = !1, h.val("").trigger("change"), v.value = ""
        }
        S.render(), I(), A = document.getElementById("eventForm"), FormValidation.formValidation(A, {
            ...
            l.classList.contains("btn-add-event") ? y && (n = {
            ...
            }, c.value && (n.url = c.value), m.checked && (n.allDay = !0), n = n, b.push(n), S.refetchEvents(), L.hide()) : y && (n = {
                id: E.id,
                title: d.value,
                start: o.value,
                end: s.value,
                ...
                display: "block",
                allDay: !!m.checked
            }, (t = n).id = parseInt(t.id), b[b.findIndex(e => e.id === t.id)] = t, S.refetchEvents(), L.hide())
            ...
            a && (a.innerHTML = "Add Event"), l.innerHTML = "Add", l.classList.remove("btn-update-event"), l.classList.add("btn-add-event"), i.classList.add("d-none"), t.classList.remove("show"), n.classList.remove("show")
        }), p && p.addEventListener("click", e => {
            e.currentTarget.checked ? document.querySelectorAll(".input-filter").forEach(e => e.checked = 1) : document.querySelectorAll(".input-filter").forEach(e => e.checked = 0), S.refetchEvents()
        }), M && M.forEach(e => {
            e.addEventListener("click", () => {
                document.querySelectorAll(".input-filter:checked").length < document.querySelectorAll(".input-filter").length ? p.checked = !1 : p.checked = !0, S.refetchEvents()
            })
        }), e.config.onChange.push(function(e) {
            S.changeView(S.view.type, moment(e[0]).format("YYYY-MM-DD")), I(), t.classList.remove("show"), n.classList.remove("show")
        })
    }
});